  ...
  return _.extend(Controls, {
    ...
    Controller: Controls.Base.extend({
      ...
      _onReportOptionsSelectionChanged: function _onReportOptionsSelectionChanged(event, data) {
        ...
        var dfd = this.inputControlsReportViewerService.fetchInitialInputControlsValuesByUri(this.dataUri, viewModel.structure, data.selectedData).then(function (options) {
