requirejs.config({
  ...
  map: {
    ...
    '*': {
      ...
      'jive.table': 'reportViewer/jasperreports/jive/jive.table',
      'jive.interactive.column': 'reportViewer/jasperreports/jive/jive.interactive.column',
      'jive.crosstab': 'reportViewer/jasperreports/jive/jive.crosstab',
      'jive.crosstab.interactive': 'reportViewer/jasperreports/jive/jive.crosstab.interactive',
      'jasperreports-map': 'reportViewer/jasperreports/map',
      'cv-component': 'reportViewer/jasperreports/cv-component',
